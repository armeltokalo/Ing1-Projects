...
def is_log_line_processed(cursor, log_hash):
    ...
    """
    cursor.execute("SELECT COUNT(*) FROM owacalendar_logs WHERE log_hash = %s", (log_hash,))
    ...
    while True:
        try:
            ...
            with connection.cursor() as cursor:
                directory_path = "C:/Users/Admin/Desktop/Projet Info/logs/httpsproxy/OwaCalendar"
